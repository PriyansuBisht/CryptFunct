 ...
 * @author Priyansu
 */
public class ImageDeFrame extends javax.swing.JFrame {
    ...
    javax.swing.ImageIcon decrypt_1_0 = new javax.swing.ImageIcon(getClass().getResource("/Resources/Icons/decrypt_1.0.png"));
    javax.swing.ImageIcon decrypt_2_0 = new javax.swing.ImageIcon(getClass().getResource("/Resources/Icons/decrypt_2.0.png"));
    ...
    private void initComponents() {
        ...
        EnPanel_basePanel.setBackground(new java.awt.Color(255, 153, 0));
        ...
        jScrollPane1.setMaximumSize(new java.awt.Dimension(729, 300));
        jScrollPane1.setMinimumSize(new java.awt.Dimension(729, 300));
        jScrollPane1.setPreferredSize(new java.awt.Dimension(729, 300));
        ...
        plainCypher_textarea.setMaximumSize(new java.awt.Dimension(320, 300));
        plainCypher_textarea.setMinimumSize(new java.awt.Dimension(320, 300));
        ...
        textKey_label.setForeground(new java.awt.Color(0, 255, 204));
        textKey_label.setText("Secret Key :");

        encryptedtext_label.setFont(new java.awt.Font("Montserrat Alternates SemiBold", 0, 18)); // NOI18N
        encryptedtext_label.setForeground(new java.awt.Color(0, 255, 204));
        encryptedtext_label.setText("Enter Encrypted Text.....");
        ...
        keySize_label.setForeground(new java.awt.Color(0, 255, 204));
        ...
        key_combobox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "64 Bytes", "128 Bytes", "256 Bytes" }));
        key_combobox.setSelectedIndex(2);
        key_combobox.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        secretKet_textbox.setBackground(new java.awt.Color(255, 173, 0));
        ...
        decrypt_button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/Icons/decrypt_1.0.png"))); // NOI18N
        ...
        decrypt_button.setMaximumSize(new java.awt.Dimension(200, 80));
        decrypt_button.setMinimumSize(new java.awt.Dimension(200, 80));
        decrypt_button.setPreferredSize(new java.awt.Dimension(151, 70));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, EnPanel_basePanelLayout.createSequentialGroup()
                        ...
                        .addGroup(EnPanel_basePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, EnPanel_basePanelLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(key_combobox, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(433, 433, 433))
                            .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addGroup(EnPanel_basePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
                                        .addComponent(encryptedtext_label, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(413, 413, 413))
                                    .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
                                        .addComponent(textKey_label)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(secretKet_textbox, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(decrypt_button, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))))))
        ...
        EnPanel_basePanelLayout.setVerticalGroup(
            ...
            .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(encryptedtext_label, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(EnPanel_basePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
                        .addComponent(decrypt_button, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
                        .addGroup(EnPanel_basePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
    ...
    private void decrypt_buttonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_decrypt_buttonMouseEntered
        // TODO add your handling code here:
        decrypt_button.setIcon(decrypt_2_0);
    ...
    private void decrypt_buttonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_decrypt_buttonMouseExited
        // TODO add your handling code here:
        decrypt_button.setIcon(decrypt_1_0);
    ...
    private void decrypt_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_decrypt_buttonActionPerformed
        ...
        cypherText = plainCypher_textarea.getText();
        ...
        try {
            ...
            Logger.getLogger(ImageDeFrame.class.getName()).log(Level.SEVERE, null, ex);
        ...
        byte[] secretkey = Base64.getDecoder().decode(secretKet_textbox.getText());
        secretKey = new SecretKeySpec(secretkey,0,secretkey.length,"AES");
        
        try {
            plainText = com.cryptoProject.FunctionalClasses.TextEnDeFunctions.decryptText(cypherText, secretKey, size, IV);
        ...
        // GOT CYPHER TEXT
        JOptionPane.showMessageDialog(this, "Decryption Successful...   ", "RESULT", JOptionPane.INFORMATION_MESSAGE);
        
        
        
        plainCypher_textarea.setText(plainText);

        jScrollPane1.setMaximumSize(new java.awt.Dimension(729, 380));
        jScrollPane1.setMinimumSize(new java.awt.Dimension(729, 380));
        jScrollPane1.setPreferredSize(new java.awt.Dimension(729, 380));
        jScrollPane1.setSize(729,380);
        
        plainCypher_textarea.setEditable(false);       
        encryptedtext_label.setText("Plain Text....");
        decrypt_button.setVisible(false);
        key_combobox.setVisible(false);
        keySize_label.setVisible(false);
    ...
    private void refresh_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refresh_buttonActionPerformed
        // TODO add your handling code here:
        ImageDeFrame textEnDeFrame = new ImageDeFrame();
    ...
    private void encryption_labelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_encryption_labelMouseClicked
        // TODO add your handling code here:
        com.cryptoProject.GUIFrames.TextEnFrame textEnFrame = new com.cryptoProject.GUIFrames.TextEnFrame();
        textEnFrame.setVisible(true);
        ImageDeFrame.this.dispose();
