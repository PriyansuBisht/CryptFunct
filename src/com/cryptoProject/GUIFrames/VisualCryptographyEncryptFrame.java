 ...
 * @author Priyansu
 */
public class VisualCryptographyEncryptFrame extends javax.swing.JFrame {

    /**
     * Creates new form TextEnDeFrame
     */
    public VisualCryptographyEncryptFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        downloadKey_button = new javax.swing.JButton();
        ...
        downloadImage_button.setText("DOWNLOAD SHARE1");
        ...
        downloadKey_button.setFont(new java.awt.Font("Orbitron ExtraBold", 1, 18)); // NOI18N
        downloadKey_button.setText("DOWNLOAD SHARE2");
        downloadKey_button.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(25, 25, 25), 3, true));
        downloadKey_button.setContentAreaFilled(false);
        downloadKey_button.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        downloadKey_button.setVisible(false);
        downloadKey_button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                downloadKey_buttonActionPerformed(evt);
            }
        });
        ...
        EnPanel_basePanelLayout.setHorizontalGroup(
            ...
            .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
                ...
                .addGroup(EnPanel_basePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, EnPanel_basePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, EnPanel_basePanelLayout.createSequentialGroup()
                            .addComponent(downloadImage_button, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(downloadKey_button, javax.swing.GroupLayout.PREFERRED_SIZE, 269, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
                ...
                .addGroup(EnPanel_basePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
                        ...
                        .addGap(35, 35, 35)
                        .addComponent(downloadImage_button, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(17, 17, 17))
                    .addGroup(EnPanel_basePanelLayout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 8, Short.MAX_VALUE)
                        .addComponent(imageBox_label, javax.swing.GroupLayout.PREFERRED_SIZE, 299, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(downloadKey_button, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(19, 19, 19))))
        );
    ...
    private void home_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_home_buttonActionPerformed
        ...
        VisualCryptographyEncryptFrame.this.dispose();
    ...
    private void encrypt_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_encrypt_buttonActionPerformed
        ...
        java.awt.image.BufferedImage bufferImage = com.cryptoProject.GUIFrames.VisualCryptogrphyFunctions.loadAndCheckSource(imageFile, 0, 0, false);
        if ( bufferImage == null) {
                JOptionPane.showMessageDialog(this, imageFile.getName() + " is not fit for encryption", "ERROR", JOptionPane.ERROR_MESSAGE);
                return;
        }

        keyImage = com.cryptoProject.GUIFrames.VisualCryptogrphyFunctions.generateKey(bufferImage.getWidth(), bufferImage.getHeight());
        encryptImage = com.cryptoProject.GUIFrames.VisualCryptogrphyFunctions.encryptImage(keyImage, bufferImage);
        if (keyImage == null || encryptImage == null) {
            JOptionPane.showMessageDialog(this, "Error while encrypting (should never happen :( )", "ERROR", JOptionPane.ERROR_MESSAGE);
        } else {
            downloadImage_button.setVisible(true);
            downloadKey_button.setVisible(true);
            JOptionPane.showMessageDialog(this, "Image Encrypted Sucessfully...", "RESULT", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void downloadKey_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_downloadKey_buttonActionPerformed
        // TODO add your handling code here:
        ...
        if(  result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ImageIO.write(keyImage, "png", fileName);
            } catch (IOException ex) {
                Logger.getLogger(VisualCryptographyEncryptFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }//GEN-LAST:event_downloadKey_buttonActionPerformed
...
//</editor-fold>
    ...
    private javax.swing.JButton downloadKey_button;
    ...
    private java.awt.image.BufferedImage encryptImage = null;
    private java.awt.image.BufferedImage keyImage = null;
}
